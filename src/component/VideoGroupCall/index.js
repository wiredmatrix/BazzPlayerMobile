 ...
 */
 ...
 class VideoGroupCall extends React.Component {
   constructor(props) {
     super(props)
   ...
   componentDidMount = () => {
     ...
     this.socket = io.connect(
       'https://e8a7d918cfcb.ngrok.io/vocPeer',
       {
         path: '/voc',
         query: {}
       }
     ...
     render() {
      ...
      return (
        ...
        <SafeAreaView style={{ flex: 1, position: 'absolute', width: dimensions.width, height: dimensions.height }}>
